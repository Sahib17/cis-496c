...
export const postExpense = async (req, res) => {
  try {
    ...
    const expensed = await expenseService.postExpense(req.user.userId, req.body, expense.withBalance, result.data);

console.log("expense: ", expense);
return res.status(200).json({success: true, expensed})
